<?php
  ...
  function apresentarSolicitacoesAdocao($conexao,$idUsuario){
    try {
      $query = $conexao->prepare("select DISTINCT adota.id_usuario as id_usu,pet_tipo.nome as nomeAni,raca.nomer,pet_tipo.imagem,pet_tipo.id_animal,usuario.nome,usuario.e_mail
